...
<div class="container">
	...
	echo "<div class='alert alert-warning mt-4' role='alert'>
					<p>Ya se encuentra registrado este email.</p>
	...
	*/
	...
	if (mysqli_query($conn, $query)) {
		echo "<div class='alert alert-success mt-4' role='alert'><h3>Cuenta ha sido creada.</h3>
		<a class='btn btn-outline-primary' href='login.html' role='button'>Inicio de sesión</a></div>";		
		} else {
